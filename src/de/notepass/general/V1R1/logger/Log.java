package de.notepass.general.V1R1.logger;

import de.notepass.general.V1R1.configuration.ConfigurationFile;
import de.notepass.general.V1R1.configuration.InternalConfigDummy;
...
public class Log {
    ...
    private static String readConfig(String part) {
        try {
            ...
            Util.showPureError("Couldn't read the configuration file. Exception is: " + e.getCause() + " Stacktrace is:" + Util.getLineSeparator() + Util.exceptionToString(e));
            System.exit(1);
        }
        return null;
    }
