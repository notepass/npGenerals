package de.notepass.general.V1R1.java7addons.configuration;

import de.notepass.general.V1R1.java7addons.gui.GroupBox;
 ...
 */
public class InternalConfigDummy extends de.notepass.general.V1R1.configuration.InternalConfigDummy {
    /**
